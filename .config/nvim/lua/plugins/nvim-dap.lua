return {
  {
    ...
    -- stylua: ignore
    keys = {
      { "<leader>dac", "<cmd>lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint Condition: '))<cr>", desc = "Breakpoint Condition" },
      { "<leader>dam", "<cmd>lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log Point Message: '))<cr>", desc = "Breakpoint Message" },
      { "<leader>db", "<cmd>lua require'dap'.toggle_breakpoint()<cr>", desc = "Breakpoint" },
      { "<leader>dC", "<cmd>lua require'dap'.run_to_cursor()<cr>", desc = "Run to Cursor" },
      { "<leader>dc", "<cmd>lua require'dap'.continue()<cr>", desc = "Continue" },
      { "<leader>dg", "<cmd>lua require'dap'.goto_()<cr>", desc = "Go to Line (no execute)" },
      { "<leader>di", "<cmd>lua require'dap'.step_into()<cr>", desc = "Step Into" },
      { "<leader>dj", "<cmd>lua require'dap'.down()<cr>", desc = "Step Into" },
      { "<leader>dk", "<cmd>lua require'dap'.up()<cr>", desc = "Step Into" },
      { "<leader>dl", "<cmd>lua require'dap'.run_last()<cr>", desc = "Run the Last" },
